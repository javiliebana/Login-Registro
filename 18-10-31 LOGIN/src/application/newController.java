...
public class newController {
	...
	private void nuevaVista() {
		try {
	        ...
	        loader.setLocation(getClass().getResource("v_registro.fxml"));
	...
	public void initialize() {
		...
		pane1.setStyle("-fx-background-image: url('application//galletas1.jpg')");
		pane2.setStyle("-fx-background-image: url('application//galletas2.jpg')");
		pane3.setStyle("-fx-background-image: url('application//galletas3.jpg')");
		pane4.setStyle("-fx-background-image: url('application//galletas4.jpg')");
